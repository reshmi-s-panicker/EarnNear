...
**Color palette:**
- Primary emerald: `#0F9D58`
- Dark emerald: `#0B7A43`
- Light emerald tint: `#D9F2E4`
- Very light emerald background: `#F3FBF6`
- Recruiter accent (dark teal): `#0F4C4C`
- Recruiter accent tint: `#DCEBEA`
- Page background: `#FAF9F6` (warm off-white)
- Card background: `#FFFFFF`
- Text primary: `#1C2521` (dark slate)
- Text secondary: `#6B7570` (medium grey)
- Border: `#E4E7E4` (light neutral)
- Success: `#22A559` · Warning: `#E0A831` · Error: `#E14D4D` · Info: `#3B82F6`
...
Progress: Account → Profile → Ready to Explore. Keep it to account basics only — no education/skills/resume at this step.
...
Progress: Account → Company Profile → Start Hiring. Dark teal accent.
...
- Registration submit → respective dashboard
